    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('routine_id', models.ForeignKey(help_text='uniquely identifies the routine', to='routines.Routine')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('routine_id', models.ForeignKey(help_text='identifies the routine template to which customer subscribed to', to='routines.Routine')),
