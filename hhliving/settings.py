"""
Django settings for hhliving project.
...
SECRET_KEY = 'x%eq33t6n$s8onb%fa_my(_)bwyecd#jhm_zdvqilc^#kz@_($'
...
WSGI_APPLICATION = 'hhliving.wsgi.application'
