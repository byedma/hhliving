...
router.register(r'edit_habits', habits_viewsets.HabitUpdateViewSet)
router.register(r'habitservices', habits_viewsets.HabitServiceListViewSet)
router.register(r'new_habitservices', habits_viewsets.NewHabitServiceViewSet)
...
router.register(r'new_hobbyservices', hobbys_viewsets.NewHobbyServiceViewSet)
...
router.register(r'new_routineservices', routines_viewsets.NewRoutineServiceViewSet)
...
router.register(r'new_challengeservices', challenges_viewsets.NewChallengeServiceViewSet)
...
router.register(r'new_programservices', programs_viewsets.NewProgramServiceViewSet)
